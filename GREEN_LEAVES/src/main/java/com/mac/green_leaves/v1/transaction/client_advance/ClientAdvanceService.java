...
public class ClientAdvanceService {
    ...
    @Autowired
    private ClientAdvanceRequestRepository clientAdvanceRepository;

    @Autowired
    private ClientAdvanceRequestDetailRepository clientAdvanceRequestDetailRepository;
