(function () {
    angular.module("appModule")
            .factory("TeaIssueSettlementModel", function (TeaIssueService, TeaIssueModelFactory, $q, $filter) {
                function TeaIssueSettlementModel() {
                    this.constructor();
                }

                TeaIssueSettlementModel.prototype = {
                    //data model
                    data: {},
                    tempData: {},
                    //client information
                    ...
                    clear: function () {
                        ...
                        this.data.type = "TEA_ISSUE_SETTLEMENT";
                    },
                    addDetail: function () {
                        var defer = $q.defer();
                        var that = this;
                ...
                return TeaIssueSettlementModel;
            });
}());