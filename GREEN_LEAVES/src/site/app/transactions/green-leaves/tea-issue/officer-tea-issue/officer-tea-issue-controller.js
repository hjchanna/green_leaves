(function () {
    ...
    angular.module("appModule")
            .controller("OfficerTeaIssueController", function ($scope, OfficerTeaIssueModel, $filter, $timeout, Notification, ConfirmPane, optionPane) {
                ...
                $scope.ui.addDetail = function () {
                    if (!$scope.model.data.route) {
                    ...
                    } else if (!$scope.model.tempData.routeOfficer) {
                        Notification.error("Please enter a valid route officer.");
                        ...
                        var isDuplicate = $scope.model.detailDuplicateCheck($scope.model.tempData.routeOfficer, $scope.model.tempData.teaIssueItem);
                        if (!isDuplicate) {
