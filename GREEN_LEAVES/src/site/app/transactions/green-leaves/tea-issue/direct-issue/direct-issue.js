(function () {
    angular.module("teasIssueModule", ['ngAnimate', 'ngSanitize', 'ui.bootstrap', 'ui-notification']);

    //http factory
    angular.module("teasIssueModule")
            .factory("teasIssueFactory", function ($http, systemConfig) {
                var factory = {};

                //load category
                factory.loadTeaGrade = function (callback) {
                    var url = systemConfig.apiUrl + "/api/v1/green-leaves/voucher-payment/update-voucher";
    ...
    angular.module("teasIssueModule")
            .controller("teasIssueController", function ($scope, categoryFactory, Notification, $timeout) {
                //data models 
                $scope.model = {};
